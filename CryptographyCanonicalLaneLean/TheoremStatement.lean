import CryptographyCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String := "cryptography-canonical-lane"
def sourceDescription : String := "Cryptography canonical lane repository"

def sourceTheoremBoundary : String := "carried"
